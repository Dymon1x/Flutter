...
const request = "https://api.hgbrasil.com/finance?format=json&key=c0c19a79";

void main() async {
  runApp(MaterialApp(
      home: Home(),
    debugShowCheckedModeBanner: false, // remove a faixa de debgumode
    theme: ThemeData(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Icon(Icons.monetization_on,
                              size: 150.0, color: Colors.blueAccent),
